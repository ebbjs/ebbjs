...
set_target_properties(RocksDB::rocksdb-shared PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/librocksdb.10.7.5.dylib"
  IMPORTED_SONAME_RELEASE "@rpath/librocksdb.10.dylib"
  )

list(APPEND _cmake_import_check_targets RocksDB::rocksdb-shared )
list(APPEND _cmake_import_check_files_for_RocksDB::rocksdb-shared "${_IMPORT_PREFIX}/lib/librocksdb.10.7.5.dylib" )
