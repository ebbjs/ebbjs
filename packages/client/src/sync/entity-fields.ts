 ...
 * by the relationship traversal helpers and the field-value reads
 * the namespace asks for. Today it owns:
 *
 ...
 * narrowing the type: typed value-shape access (`FieldValueFor<...>`)
 * is a downstream concern — the schema layer emits those types where
 * the static narrowing matters at the call site, not at this
 * storage-shape bridge.
 */
