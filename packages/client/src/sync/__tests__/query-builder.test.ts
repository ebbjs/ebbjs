 ...
 * chain DSL extracted from `sync/relationship.ts` per #158.
 *
 * Covers:
 * - equality, ordering, limit evaluation against an `Entity[]` candidates
 *   set;
...
import { buildQueryBuilder, apply, type QueryBuilder } from "../query-builder";
